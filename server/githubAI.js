...
الجملة المطلوب إكمالها:
"${template}"

${roleInstruction}

⚠️ القواعد الصارمة:
1. اكتب الجملة كاملة مع استبدال كل _____ بكلمة أو عبارة قصيرة مناسبة.
2. لا تغيّر أي كلمة أخرى في الجملة.
3. لا تضف مقدمات، شرحاً، أو علامات اقتباس.
4. اكتب بالعربية فقط.
5. الرد يجب أن يكون الجملة المكتملة فقط — لا أكثر.
6. تأكد أن إجابتك مختلفة عن هذه الإجابات السابقة في اللعبة: ${scenario._prevAnswers || 'لا يوجد'}.
