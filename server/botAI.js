...
const ANSWER_TEMPLATES = {
  ...
  [ROLE_TYPES.FORGER]: [
    "أعتقد أن القصة تدور حول {keywords}... نعم، بالتأكيد!",
    "من خبرتي، أظن أن {keywords} حدثت هنا",
    "التفاصيل تشير إلى {keywords} بوضوح",
    "لا أذكر كل شيء لكن {keywords} كانت واضحة",
    "ربما {keywords} والباقي غامض قليلاً"
  ],
  
  [ROLE_TYPES.INFILTRATOR]: [
    "أنا أراقب الجميع بحذر... {keywords} تبدو مريبة 👁️",
    "شيء غريب يحدث... أظن أن {keywords} مهمة",
    "أتابع الأحداث عن كثب، {keywords} لافتة للانتباه",
    "لدي شكوك حول {keywords}... سأراقب أكثر",
    "الوضع غامض ولكن {keywords} واضحة نوعاً ما"
  ],
  
  [ROLE_TYPES.ACCOMPLICE]: [
    "أنا متفق مع ما قيل، {keywords} منطقية جداً",
    "نعم، أؤيد هذا الرأي... {keywords} صحيحة",
    "أظن أن الجميع على حق، {keywords} واضحة",
    "لا أريد إثارة المشاكل، {keywords} تبدو جيدة",
    "ليس لدي اعتراضات، {keywords} معقولة"
  ],
  
  [ROLE_TYPES.LAWYER]: [
    "من الناحية القانونية، {keywords} تحتاج إثباتات",
    "يجب احترام حقوق الجميع. {keywords} ليست دليلاً قاطعاً",
    "لا توجد أدلة كافية بعد، {keywords} غير كافية",
    "أطالب بالعدالة، {keywords} قد تكون مضللة",
    "حسب القانون، {keywords} تحتاج تحقيق أعمق"
  ],
  ...
  [ROLE_TYPES.ANALYST]: [
    "تحليلي للبيانات يشير إلى {keywords}",
    "الأنماط السلوكية تدل على {keywords}",
    "بعد دراسة الحالة، {keywords} هي الأكثر احتمالاً",
    "الإحصائيات تؤكد {keywords} بنسبة عالية",
    "النماذج تظهر {keywords} كعامل رئيسي"
  ],
  
  [ROLE_TYPES.OFFICER]: [
    "كضابط، رأيت {keywords} وهي مثيرة للشك",
    "الإجراءات القانونية تتطلب التحقيق في {keywords}",
    "لدي تقرير عن {keywords} من الميدان",
    "شاهدت {keywords} بنفسي أثناء الدورية",
    "التحقيق الميداني كشف {keywords}"
  ],
