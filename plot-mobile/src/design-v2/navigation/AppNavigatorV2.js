/**
 * design-v2/navigation/AppNavigatorV2.js
 * V2 navigator — same routes as V1, all screens from design-v2/screens/
 */
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name={ROUTES.HOST_QUALITY_VOTING}>
        {() => <HostVotingScreen route={{ params: { votingType: 'quality' } }} />}
      </Stack.Screen>
      ...
      <Stack.Screen name={ROUTES.HOST_CULPRIT_VOTING}>
        {() => <HostVotingScreen route={{ params: { votingType: 'culprit' } }} />}
      </Stack.Screen>
