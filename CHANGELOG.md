...
### تحسين تمييز نصوص البلتز وإخفاء تفاصيل النقاط 🎨🔒

#### 1. تلوين الكلمات المدخلة في شاشات تصويت الجودة والجاني (Blitz Mode)
...
#### 2. حماية سرية الأدوار في شاشة النتائج (النتائج غير الحاسمة)
