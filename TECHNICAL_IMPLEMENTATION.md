...
### أخر التحديثات (2026-02-08 - V4 Rules & UI Overhaul):
- ✅ **قواعد V4**: تفعيل نظام الفرق (Justice vs Crime) وآليات الفوز الجديدة.
- ✅ **Minimalist UI**: إعادة تصميم واجهة الويب والوضع الأفقي للجوال لتكون أصغر (50% scale) وأكثر كثافة.
- ✅ **Game Flow**: إلغاء مرحلة النقاش واستبدالها بالعرض التشويقي والتصويت المباشر.
- ✅ **Scoring System**: نظام نقاط شامل (مكافآت الفرق، النجاة، كشف الجاني).
- ✅ **Offer Mechanism**: نظام العروض والمفاوضات (المستفيد/الوزير/العقل المدبر).
- ✅ **Live Voting**: عرض حي للتصويت للمضيف.
- ✅ **Game Guide**: شاشة "دليل اللعبة" داخل التطبيق.
...
6. ✅ **Culprit Voting**: تصويت مباشر على الجاني (بدون نقاش)
7. ✅ **Results Phase**: حساب ونشر النتائج مع نظام الفرق والمكافآت
8. ✅ **Multi-Round System**: دعم جولات متعددة
9. ✅ **Live Voting Display**: عرض التصويتات الحية للمضيف
...
│       │   ├── HowToPlayScreen.js         # شاشة دليل اللعبة (جديد)
