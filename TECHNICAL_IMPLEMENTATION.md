...
## حالة المشروع الحالية (الإصدار 1.1)
...
- **التصميم المتجاوب (Responsive):**
  ...
  - **Landscape (Mobile/Web):** تصميم أفقي متكامل يدعم تدوير الجهاز.
- **تحسينات وضوح النصوص**: زيادة أحجام الخطوط، تدعيم الأوزان (Bold)، وإضافة طبقة تباين لضمان القراءة الواضحة.
...
- **Training Flow:**
    ...
    2. ينضم لغرفة موجودة (Host Room) باستخدام الرمز.
    3. يكتشف الخادم طلب التدريب (`desiredRole`) ويقوم بتحويل الغرفة لوضع التدريب، وتعيين الدور، وملء المقاعد الشاغرة بـ 7 بوتات تلقائياً.
- **Manual Bot Auto-fill:**
    - يمكن للمضيف (Host) استخدام زر "🤖 تعبئة بوتات" لملء أي غرفة بروبوتات ذكية، مما يسمح بتجربة اللعبة حتى بدون عدد كافٍ من اللاعبين البشر.
- **Bot logic:** الروبوتات تقوم بمحاكاة الكتابة والتصويت بناءً على قواعد عشوائية ذكية.
...
### تحسينات التصويت والتقارير
- **عرض شبكي**: تظهر التقارير الواردة على شاشة المضيف بتنسيق مربعات حوار (Square Cards) جذابة لجعل القراءة أمتع.
- **شفافية الأسماء**: تظهر أسماء اللاعبين الآن بجانب إجاباتهم في مرحلة التصويت لتمكين اللاعبين من معرفة صاحب كل رأي.
