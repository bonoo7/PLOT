...
## حالة المشروع الحالية (الإصدار 3.7.0)

### آخر التحديثات (2026-05-22 — v3.7.0 — نظام التصميم V3 "Retro Terminal"):
- ✅ **نظام تصميم V3 كامل الافتراضي**: 13 مكوناً و10 شاشات تحت `plot-mobile/src/design-v3/`
- ✅ **تنسيق أحادي اللون (Monochrome)**: ثيم محاكي للترمينال القديم باللونين الأخضر والأمبر الفسفوري
- ✅ **تخطيط ثلاثي محمي**: `TerminalLayout` مع دعم كامل للمتصفح والأجهزة الذكية والـ SafeArea
- ✅ **تأثيرات شاشات CRT**: دمج `ScanLines`, `GlitchText`, `BlinkCursor` و `TerminalTypewriter`
- ✅ **منع تسريب الأدوار**: حظر كشف breakdown النقاط في شاشات المضيف واللاعبين عند استمرار الجولة
- ✅ **تلوين نصوص البلتز**: تمييز الكلمات المكتملة بالأصفر المضيء في شاشات التصويت عبر مزامنة قالب السيناريو
- ✅ **شاشة نقاش المضيف**: هيكلية متجاورة، إخفاء/إظهار ديناميكي للوحات، وتضخيم هوية المتحدث وموجاته الصوتية
